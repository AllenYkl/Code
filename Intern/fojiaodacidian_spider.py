...
strokes = ['一画','二画','三画','四画','五画','六画', '七画', '八画', '九画'
        ,'十画', '十一画', '十二画', '十三画', '十四画', '十五画', '十六画'
        ,'十七画', '十八画以上']

flags = ['001','002','003','004','005','006','007','008','009','010','011','012'
         ,'013', '014', '015', '016', '017', '018']

amounts = [115, 430, 984, 1269, 913, 1211, 1157, 1567, 862, 773, 790, 767, 408, 191, 274, 54, 65, 57]
